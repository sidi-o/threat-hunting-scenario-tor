...
Searched for any indication that user "employee" actually opened the TOR browser. There was evidence that they did open it at `2026-03-08T22:10:45.3080097Z`. There were several other instances of `firefox.exe` (TOR) as well as `tor.exe` spawned afterwards.
...
Searched for any indication the TOR browser was used to establish a connection using any of the known TOR ports. At `2026-03-08T22:11:25.8094918Z`, an employee on the "threat-hunt-lab" device successfully established a connection to the remote IP address `94.23.121.150` on port `9001`. The connection was initiated by the process `tor.exe`, located in the folder `c:\users\labuser\desktop\tor browser\browser\torbrowser\tor\tor.exe`. There were a couple of other connections to sites over port `443`.
